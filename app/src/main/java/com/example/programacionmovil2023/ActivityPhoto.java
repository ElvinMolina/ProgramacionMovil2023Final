...
public class ActivityPhoto extends AppCompatActivity {
    ...
    private void permisos(){
        //Método para obtener los permisos requeridos de la aplicación
        ...
        if(requestCode == PETICION_ACCESS_CAM){
            if(grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED)
            {
               // TomarFoto();
                ...
                Toast.makeText(getApplicationContext(), "Se necesita el permiso de la cámara",Toast.LENGTH_LONG).show();
            }
        }
        ...
        if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
            ...
            if (photoFile != null) {
                Uri photoURI = FileProvider.getUriForFile(this,
                        "com.example.programacionmovil2023.fileprovider",
                        photoFile);
